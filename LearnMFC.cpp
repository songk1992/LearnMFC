...
// LearnMFC.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
#include "ChildFrm.h"
#include "LearnMFCDoc.h"
#include "LearnMFCView.h"
...
BOOL CLearnMFCApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_LearnMFCTYPE,
